...
# ---------------------------------------------------------------------------
# Greeting patterns — multilingual (English, Arabic, Hindi)
# ---------------------------------------------------------------------------
GREETING_PATTERNS = [
    # English
    ...
    # Arabic — مرحبا، أهلا، السلام عليكم، هلا
