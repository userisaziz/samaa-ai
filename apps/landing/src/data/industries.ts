...
export const industries: Industry[] = [
  {
    ...
    heroDescription: 'Jewellery sales are shaped by emotion, confidence, and reassurance. CXSAMAA helps uncover the moments that build trust—or prevent a customer from buying.',
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures what builds confidence',
        descriptions: [
          'CXSAMAA identifies patterns across conversations: where buyers seek reassurance on authenticity, what creates hesitation around design or pricing, and which moments strengthen emotional certainty.',
        ],
        imageAlt: 'CXSAMAA device illustration',
      },
      {
        number: 3,
        title: 'Managers coach with greater precision',
        descriptions: [
          'CXSAMAA turns daily interactions into clear signals of buying intent, repeatable trust-building behaviors, and calmer, more confident guidance on the floor.',
  ...
  },
  {
    ...
    heroDescription: 'Furniture purchases involve careful consideration. CXSAMAA reveals what helps customers move forward—and what causes them to delay decisions.',
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures what builds certainty',
        descriptions: [
          'CXSAMAA identifies patterns across furniture conversations: reassurance on durability or fit, hesitation around materials or pricing, and moments that strengthen comfort confidence.',
        ],
        imageAlt: 'CXSAMAA device illustration',
      },
      {
        ...
        descriptions: [
          'CXSAMAA turns daily interactions into clear signals of purchase intent, repeatable trust-building behaviors, and calmer, more confident selling support.',
  ...
  },
  {
    ...
    heroDescription: 'Major purchases involve questions, concerns, and careful evaluation. CXSAMAA highlights the moments that accelerate—or delay—the buying journey.',
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures what drives purchase confidence',
        descriptions: [
          'CXSAMAA identifies patterns across showroom conversations:',
      ...
      },
      {
        ...
        title: 'Managers coach with clarity',
        descriptions: [
          'CXSAMAA turns daily interactions into:',
  ...
  },
  {
    ...
    heroDescription: 'Customers need guidance before committing to large projects. CXSAMAA helps teams understand what information customers need to make decisions.',
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures what drives decisions',
  ...
  },
  {
    ...
    heroDescription: 'Buying decisions are driven by fit, confidence, and personal preference. CXSAMAA reveals the interactions that influence purchase decisions.',
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures what closes the sale',
  ...
  },
  {
    ...
    heroDescription: 'Customers compare features, value, and alternatives before buying. CXSAMAA uncovers the conversations that influence their final decision.',
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures what influences decisions',
  ...
  },
  {
    ...
    howItWorks: [
      ...
      {
        number: 2,
        title: 'CXSAMAA captures service excellence',
